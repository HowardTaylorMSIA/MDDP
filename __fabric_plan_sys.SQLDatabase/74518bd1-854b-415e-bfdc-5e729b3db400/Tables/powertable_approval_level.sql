CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_approval] ([id])
);
