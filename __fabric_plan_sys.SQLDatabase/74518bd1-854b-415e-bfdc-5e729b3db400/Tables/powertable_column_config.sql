CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_source] ([id])
);
