CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_automation_jobs] ([id])
);
