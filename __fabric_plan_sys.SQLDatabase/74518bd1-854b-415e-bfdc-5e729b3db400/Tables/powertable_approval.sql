CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_source] ([id])
);
