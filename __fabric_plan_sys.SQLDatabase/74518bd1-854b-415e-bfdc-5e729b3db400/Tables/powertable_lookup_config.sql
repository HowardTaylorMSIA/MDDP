CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_source] ([id])
);
