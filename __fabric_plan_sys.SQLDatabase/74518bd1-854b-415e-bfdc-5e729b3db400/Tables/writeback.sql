CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[visual] ([id])
);
