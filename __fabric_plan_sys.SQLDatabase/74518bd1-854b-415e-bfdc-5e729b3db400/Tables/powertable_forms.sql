CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_source] ([id])
);
