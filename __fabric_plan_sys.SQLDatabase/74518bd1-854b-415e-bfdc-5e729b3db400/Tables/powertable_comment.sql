CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_source] ([id])
);
