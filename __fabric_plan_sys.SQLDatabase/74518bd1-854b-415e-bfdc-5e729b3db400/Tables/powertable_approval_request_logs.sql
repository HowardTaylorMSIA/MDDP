CREATE TABLE [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [74518bd1-854b-415e-bfdc-5e729b3db400].[powertable_approval_request] ([id])
);
