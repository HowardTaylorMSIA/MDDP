              ...
              CREATE PROCEDURE [ce92d282-104a-43a6-8407-b1a37af182e0].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [ce92d282-104a-43a6-8407-b1a37af182e0].powertable_approval_request_rows SET status = 500 FROM [ce92d282-104a-43a6-8407-b1a37af182e0].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
