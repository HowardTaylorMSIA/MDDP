CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[visual] ([id]) ON DELETE CASCADE
);
