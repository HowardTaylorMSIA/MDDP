CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[visual] ([id])
);
