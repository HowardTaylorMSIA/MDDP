CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_approval_request] ([id])
);
