CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_source] ([id])
);
