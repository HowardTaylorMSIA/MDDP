CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_source] ([id])
);
