CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_source] ([id])
);
