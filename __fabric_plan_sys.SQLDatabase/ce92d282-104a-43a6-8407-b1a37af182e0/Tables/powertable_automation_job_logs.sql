CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_automation_jobs] ([id])
);
