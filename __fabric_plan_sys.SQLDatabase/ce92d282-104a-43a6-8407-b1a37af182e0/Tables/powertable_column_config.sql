CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[powertable_source] ([id])
);
