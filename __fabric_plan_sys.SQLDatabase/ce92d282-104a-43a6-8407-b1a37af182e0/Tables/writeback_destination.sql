CREATE TABLE [ce92d282-104a-43a6-8407-b1a37af182e0].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [ce92d282-104a-43a6-8407-b1a37af182e0].[visual] ([id])
);
