            ...
            CREATE PROCEDURE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [cce51655-5aaf-4fb2-9127-5772b6e43a21].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [cce51655-5aaf-4fb2-9127-5772b6e43a21].data_input_row
                INNER JOIN [cce51655-5aaf-4fb2-9127-5772b6e43a21].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
