              ...
              CREATE PROCEDURE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [cce51655-5aaf-4fb2-9127-5772b6e43a21].powertable_approval_request_rows SET status = 500 FROM [cce51655-5aaf-4fb2-9127-5772b6e43a21].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
