CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[visual] ([id])
);
