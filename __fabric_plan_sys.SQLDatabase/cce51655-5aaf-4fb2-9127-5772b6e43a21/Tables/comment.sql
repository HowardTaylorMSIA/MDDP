CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[visual] ([id]) ON DELETE CASCADE
);
