CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_source] ([id])
);
