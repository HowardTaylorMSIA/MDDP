CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_source] ([id])
);
