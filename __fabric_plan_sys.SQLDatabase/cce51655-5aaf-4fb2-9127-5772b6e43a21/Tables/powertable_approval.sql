CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_source] ([id])
);
