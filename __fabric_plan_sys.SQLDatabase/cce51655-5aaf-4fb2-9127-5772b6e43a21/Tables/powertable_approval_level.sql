CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_approval] ([id])
);
