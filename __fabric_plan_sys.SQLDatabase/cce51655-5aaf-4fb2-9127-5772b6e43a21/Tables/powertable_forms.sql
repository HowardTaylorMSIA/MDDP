CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_source] ([id])
);
