CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_approval_request] ([id])
);
