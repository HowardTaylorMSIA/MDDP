CREATE TABLE [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [cce51655-5aaf-4fb2-9127-5772b6e43a21].[powertable_approval_request] ([id])
);
