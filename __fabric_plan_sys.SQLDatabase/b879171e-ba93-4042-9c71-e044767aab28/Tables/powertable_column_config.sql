CREATE TABLE [b879171e-ba93-4042-9c71-e044767aab28].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [b879171e-ba93-4042-9c71-e044767aab28].[powertable_source] ([id])
);
