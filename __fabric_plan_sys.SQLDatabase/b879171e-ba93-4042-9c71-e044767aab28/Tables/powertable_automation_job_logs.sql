CREATE TABLE [b879171e-ba93-4042-9c71-e044767aab28].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [b879171e-ba93-4042-9c71-e044767aab28].[powertable_automation_jobs] ([id])
);
