CREATE TABLE [b879171e-ba93-4042-9c71-e044767aab28].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [b879171e-ba93-4042-9c71-e044767aab28].[visual] ([id]) ON DELETE CASCADE
);
