CREATE TABLE [b879171e-ba93-4042-9c71-e044767aab28].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [b879171e-ba93-4042-9c71-e044767aab28].[powertable_approval] ([id])
);
