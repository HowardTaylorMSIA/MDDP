CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_source] ([id])
);
