CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_approval_request] ([id])
);
