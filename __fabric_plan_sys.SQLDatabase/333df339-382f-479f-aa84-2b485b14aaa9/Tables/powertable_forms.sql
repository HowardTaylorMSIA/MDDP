CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_source] ([id])
);
