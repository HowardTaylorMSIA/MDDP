CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[visual] ([id]) ON DELETE CASCADE
);
