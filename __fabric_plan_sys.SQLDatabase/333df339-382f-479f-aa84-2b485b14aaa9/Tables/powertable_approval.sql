CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_source] ([id])
);
