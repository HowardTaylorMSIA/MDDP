CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_approval] ([id])
);
