CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [333df339-382f-479f-aa84-2b485b14aaa9].[ib_query_writeback_destination]([queryId] ASC);
