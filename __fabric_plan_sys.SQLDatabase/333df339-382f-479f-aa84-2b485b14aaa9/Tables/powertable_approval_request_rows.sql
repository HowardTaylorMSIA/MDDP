CREATE TABLE [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [333df339-382f-479f-aa84-2b485b14aaa9].[powertable_approval_request] ([id])
);
